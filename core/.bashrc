...
alias mreconf='sudo rm /home/minerstat/minerstat-os/bin/random.txt; sudo nvidia-xconfig -a --allow-empty-initial-configuration --cool-bits=28 --use-display-device="DFP-0" --connected-monitor="DFP-0" --enable-all-gpus; sudo su -c "echo 1 > /proc/sys/kernel/sysrq"; sudo su -c "echo b > /proc/sysrq-trigger";'
